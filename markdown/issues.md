...
### root cause: network <!-- .element: class="fragment" data-fragment-index="3" -->
  ...
  * shared network with other services <!-- .element: class="fragment" data-fragment-index="7" -->
...
* restart of MDS did help<!-- .element: class="fragment" data-fragment-index="0" -->
* drop of caches did not help <!-- .element: class="fragment" data-fragment-index="1" -->
* switching to another MDS improved performance <!-- .element: class="fragment" data-fragment-index="2" -->
* Issue solved by switch to SES 6.0 <!-- .element: class="fragment" data-fragment-index="3" -->
